...
const u16 gSpeciesToHoennPokedexNum[NUM_SPECIES] = // Assigns all species to the Hoenn Dex Index (Summary No. for Hoenn Dex)
{
    ...
    SPECIES_TO_HOENN(SENTRET), //15
    SPECIES_TO_HOENN(FURRET), //16
    SPECIES_TO_HOENN(PICHU), //17
    SPECIES_TO_HOENN(PIKACHU), //18
    SPECIES_TO_HOENN(RAICHU), //19
    SPECIES_TO_HOENN(AZURILL), //20
    SPECIES_TO_HOENN(MARILL), //21
    SPECIES_TO_HOENN(AZUMARILL), //22
    SPECIES_TO_HOENN(NIDORAN_F), //23
    SPECIES_TO_HOENN(NIDORINA), //24
    SPECIES_TO_HOENN(NIDOQUEEN), //25
    SPECIES_TO_HOENN(NIDORAN_M), //26
    SPECIES_TO_HOENN(NIDORINO), //27
    SPECIES_TO_HOENN(NIDOKING), //28
    SPECIES_TO_HOENN(RALTS), //29
    SPECIES_TO_HOENN(KIRLIA), //30
    SPECIES_TO_HOENN(GARDEVOIR), //31
    SPECIES_TO_HOENN(GALLADE), //32
    SPECIES_TO_HOENN(CATERPIE), //33
    SPECIES_TO_HOENN(METAPOD), //34
    SPECIES_TO_HOENN(BUTTERFREE), //35
    SPECIES_TO_HOENN(WEEDLE), //36
    SPECIES_TO_HOENN(KAKUNA), //37
    SPECIES_TO_HOENN(BEEDRILL), //38
    SPECIES_TO_HOENN(SEWADDLE), //39
    SPECIES_TO_HOENN(SWADLOON), //40
    SPECIES_TO_HOENN(LEAVANNY), //41
    SPECIES_TO_HOENN(VENIPEDE), //42
    SPECIES_TO_HOENN(WHIRLIPEDE), //43
    SPECIES_TO_HOENN(SCOLIPEDE), //44
    SPECIES_TO_HOENN(SLAKOTH), //45
    SPECIES_TO_HOENN(VIGOROTH), //46
    SPECIES_TO_HOENN(SLAKING), //47
    SPECIES_TO_HOENN(MEOWTH), //48
    SPECIES_TO_HOENN(PERSIAN), //49
    SPECIES_TO_HOENN(ABRA), //50
    SPECIES_TO_HOENN(KADABRA), //51
    SPECIES_TO_HOENN(ALAKAZAM), //52
    SPECIES_TO_HOENN(GROWLITHE), //53
    SPECIES_TO_HOENN(ARCANINE), //54
    SPECIES_TO_HOENN(IGGLYBUFF), //55
    SPECIES_TO_HOENN(JIGGLYPUFF), //56
    SPECIES_TO_HOENN(WIGGLYTUFF), //57
    SPECIES_TO_HOENN(PACHIRISU), //58
    SPECIES_TO_HOENN(TRUBBISH), //59
    SPECIES_TO_HOENN(GARBODOR), //60
    SPECIES_TO_HOENN(ZUBAT), //61
    SPECIES_TO_HOENN(GOLBAT), //62
    SPECIES_TO_HOENN(CROBAT), //63
    SPECIES_TO_HOENN(MACHOP), //64
    SPECIES_TO_HOENN(MACHOKE), //65
    SPECIES_TO_HOENN(MACHAMP), //66
    SPECIES_TO_HOENN(SKIDDO), //67
    SPECIES_TO_HOENN(GOGOAT), //68
    SPECIES_TO_HOENN(LITLEO), //69
    SPECIES_TO_HOENN(PYROAR), //70
    SPECIES_TO_HOENN(ROGGENROLA), //71
    SPECIES_TO_HOENN(BOLDORE), //72
    SPECIES_TO_HOENN(GIGALITH), //73
    SPECIES_TO_HOENN(ARON), //74
    SPECIES_TO_HOENN(LAIRON), //75
    SPECIES_TO_HOENN(AGGRON), //76
    SPECIES_TO_HOENN(BUDEW), //77
    SPECIES_TO_HOENN(ROSELIA), //78
    SPECIES_TO_HOENN(ROSERADE), //79
    SPECIES_TO_HOENN(TYROGUE), //80
    SPECIES_TO_HOENN(HITMONLEE), //81
    SPECIES_TO_HOENN(HITMONCHAN), //82
    SPECIES_TO_HOENN(HITMONTOP), //83
    SPECIES_TO_HOENN(ROTOM), //84
};
...
const u16 gHoennToNationalOrder[HOENN_DEX_COUNT] = // Assigns Hoenn Dex Pokémon (Using National Dex Index)
{
    ...
    HOENN_TO_NATIONAL(SENTRET), //15
    HOENN_TO_NATIONAL(FURRET), //16
    HOENN_TO_NATIONAL(PICHU), //17
    HOENN_TO_NATIONAL(PIKACHU), //18
    HOENN_TO_NATIONAL(RAICHU), //19
    HOENN_TO_NATIONAL(AZURILL), //20
    HOENN_TO_NATIONAL(MARILL), //21
    HOENN_TO_NATIONAL(AZUMARILL), //22
    HOENN_TO_NATIONAL(NIDORAN_F), //23
    HOENN_TO_NATIONAL(NIDORINA), //24
    HOENN_TO_NATIONAL(NIDOQUEEN), //25
    HOENN_TO_NATIONAL(NIDORAN_M), //26
    HOENN_TO_NATIONAL(NIDORINO), //27
    HOENN_TO_NATIONAL(NIDOKING), //28
    HOENN_TO_NATIONAL(RALTS), //29
    HOENN_TO_NATIONAL(KIRLIA), //30
    HOENN_TO_NATIONAL(GARDEVOIR), //31
    HOENN_TO_NATIONAL(GALLADE), //32
    HOENN_TO_NATIONAL(CATERPIE), //33
    HOENN_TO_NATIONAL(METAPOD), //34
    HOENN_TO_NATIONAL(BUTTERFREE), //35
    HOENN_TO_NATIONAL(WEEDLE), //36
    HOENN_TO_NATIONAL(KAKUNA), //37
    HOENN_TO_NATIONAL(BEEDRILL), //38
    HOENN_TO_NATIONAL(SEWADDLE), //39
    HOENN_TO_NATIONAL(SWADLOON), //40
    HOENN_TO_NATIONAL(LEAVANNY), //41
    HOENN_TO_NATIONAL(VENIPEDE), //42
    HOENN_TO_NATIONAL(WHIRLIPEDE), //43
    HOENN_TO_NATIONAL(SCOLIPEDE), //44
    HOENN_TO_NATIONAL(SLAKOTH), //45
    HOENN_TO_NATIONAL(VIGOROTH), //46
    HOENN_TO_NATIONAL(SLAKING), //47
    HOENN_TO_NATIONAL(MEOWTH), //48
    HOENN_TO_NATIONAL(PERSIAN), //49
    HOENN_TO_NATIONAL(ABRA), //50
    HOENN_TO_NATIONAL(KADABRA), //51
    HOENN_TO_NATIONAL(ALAKAZAM), //52
    HOENN_TO_NATIONAL(GROWLITHE), //53
    HOENN_TO_NATIONAL(ARCANINE), //54
    HOENN_TO_NATIONAL(IGGLYBUFF), //55
    HOENN_TO_NATIONAL(JIGGLYPUFF), //56
    HOENN_TO_NATIONAL(WIGGLYTUFF), //57
    HOENN_TO_NATIONAL(PACHIRISU), //58
    HOENN_TO_NATIONAL(TRUBBISH), //59
    HOENN_TO_NATIONAL(GARBODOR), //60
    HOENN_TO_NATIONAL(ZUBAT), //61
    HOENN_TO_NATIONAL(GOLBAT), //62
    HOENN_TO_NATIONAL(CROBAT), //63
    HOENN_TO_NATIONAL(MACHOP), //64
    HOENN_TO_NATIONAL(MACHOKE), //65
    HOENN_TO_NATIONAL(MACHAMP), //66
    HOENN_TO_NATIONAL(SKIDDO), //67
    HOENN_TO_NATIONAL(GOGOAT), //68
    HOENN_TO_NATIONAL(LITLEO), //69
    HOENN_TO_NATIONAL(PYROAR), //70
    HOENN_TO_NATIONAL(ROGGENROLA), //71
    HOENN_TO_NATIONAL(BOLDORE), //72
    HOENN_TO_NATIONAL(GIGALITH), //73
    HOENN_TO_NATIONAL(ARON), //74
    HOENN_TO_NATIONAL(LAIRON), //75
    HOENN_TO_NATIONAL(AGGRON), //76
    HOENN_TO_NATIONAL(BUDEW), //77
    HOENN_TO_NATIONAL(ROSELIA), //78
    HOENN_TO_NATIONAL(ROSERADE), //79
    HOENN_TO_NATIONAL(TYROGUE), //80
    HOENN_TO_NATIONAL(HITMONLEE), //81
    HOENN_TO_NATIONAL(HITMONCHAN), //82
    HOENN_TO_NATIONAL(HITMONTOP), //83
    HOENN_TO_NATIONAL(ROTOM), //84
};
