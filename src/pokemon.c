...
const u16 gSpeciesToHoennPokedexNum[NUM_SPECIES] = // Assigns all species to the Hoenn Dex Index (Summary No. for Hoenn Dex)
{
    ...
    SPECIES_TO_HOENN(SKWOVET), //10
    SPECIES_TO_HOENN(GREEDENT), //11
    ...
    SPECIES_TO_HOENN(SEWADDLE), //33
    SPECIES_TO_HOENN(SWADLOON), //34
    SPECIES_TO_HOENN(LEAVANNY), //35
    SPECIES_TO_HOENN(VENIPEDE), //36
    SPECIES_TO_HOENN(WHIRLIPEDE), //37
    SPECIES_TO_HOENN(SCOLIPEDE), //38
    SPECIES_TO_HOENN(SLAKOTH), //39
    SPECIES_TO_HOENN(VIGOROTH), //40
    SPECIES_TO_HOENN(SLAKING), //41
    SPECIES_TO_HOENN(MEOWTH), //42
    SPECIES_TO_HOENN(PERSIAN), //43
    SPECIES_TO_HOENN(ABRA), //44
    SPECIES_TO_HOENN(KADABRA), //45
    SPECIES_TO_HOENN(ALAKAZAM), //46
    SPECIES_TO_HOENN(GROWLITHE), //47
    SPECIES_TO_HOENN(ARCANINE), //48
    SPECIES_TO_HOENN(IGGLYBUFF), //49
    SPECIES_TO_HOENN(JIGGLYPUFF), //50
    SPECIES_TO_HOENN(WIGGLYTUFF), //51
    SPECIES_TO_HOENN(PACHIRISU), //52
    SPECIES_TO_HOENN(TRUBBISH), //53
    SPECIES_TO_HOENN(GARBODOR), //54
    SPECIES_TO_HOENN(ZUBAT), //55
    SPECIES_TO_HOENN(GOLBAT), //56
    SPECIES_TO_HOENN(CROBAT), //57
    SPECIES_TO_HOENN(MACHOP), //58
    SPECIES_TO_HOENN(MACHOKE), //59
    SPECIES_TO_HOENN(MACHAMP), //60
    SPECIES_TO_HOENN(SKIDDO), //61
    SPECIES_TO_HOENN(GOGOAT), //62
    SPECIES_TO_HOENN(LITLEO), //63
    SPECIES_TO_HOENN(PYROAR), //64
    SPECIES_TO_HOENN(ROGGENROLA), //65
    SPECIES_TO_HOENN(BOLDORE), //66
    SPECIES_TO_HOENN(GIGALITH), //67
    SPECIES_TO_HOENN(ARON), //68
    SPECIES_TO_HOENN(LAIRON), //69
    SPECIES_TO_HOENN(AGGRON), //70
    SPECIES_TO_HOENN(BUDEW), //71
    SPECIES_TO_HOENN(ROSELIA), //72
    SPECIES_TO_HOENN(ROSERADE), //73
    SPECIES_TO_HOENN(TYROGUE), //74
    SPECIES_TO_HOENN(HITMONLEE), //75
    SPECIES_TO_HOENN(HITMONCHAN), //76
    SPECIES_TO_HOENN(HITMONTOP), //77
    SPECIES_TO_HOENN(ROTOM), //78
};
...
const u16 gHoennToNationalOrder[HOENN_DEX_COUNT] = // Assigns Hoenn Dex Pokémon (Using National Dex Index)
{
    ...
    HOENN_TO_NATIONAL(SKWOVET), //10
    HOENN_TO_NATIONAL(GREEDENT), //11
    ...
    HOENN_TO_NATIONAL(SEWADDLE), //33
    HOENN_TO_NATIONAL(SWADLOON), //34
    HOENN_TO_NATIONAL(LEAVANNY), //35
    HOENN_TO_NATIONAL(VENIPEDE), //36
    HOENN_TO_NATIONAL(WHIRLIPEDE), //37
    HOENN_TO_NATIONAL(SCOLIPEDE), //38
    HOENN_TO_NATIONAL(SLAKOTH), //39
    HOENN_TO_NATIONAL(VIGOROTH), //40
    HOENN_TO_NATIONAL(SLAKING), //41
    HOENN_TO_NATIONAL(MEOWTH), //42
    HOENN_TO_NATIONAL(PERSIAN), //43
    HOENN_TO_NATIONAL(ABRA), //44
    HOENN_TO_NATIONAL(KADABRA), //45
    HOENN_TO_NATIONAL(ALAKAZAM), //46
    HOENN_TO_NATIONAL(GROWLITHE), //47
    HOENN_TO_NATIONAL(ARCANINE), //48
    HOENN_TO_NATIONAL(IGGLYBUFF), //49
    HOENN_TO_NATIONAL(JIGGLYPUFF), //50
    HOENN_TO_NATIONAL(WIGGLYTUFF), //51
    HOENN_TO_NATIONAL(PACHIRISU), //52
    HOENN_TO_NATIONAL(TRUBBISH), //53
    HOENN_TO_NATIONAL(GARBODOR), //54
    HOENN_TO_NATIONAL(ZUBAT), //55
    HOENN_TO_NATIONAL(GOLBAT), //56
    HOENN_TO_NATIONAL(CROBAT), //57
    HOENN_TO_NATIONAL(MACHOP), //58
    HOENN_TO_NATIONAL(MACHOKE), //59
    HOENN_TO_NATIONAL(MACHAMP), //60
    HOENN_TO_NATIONAL(SKIDDO), //61
    HOENN_TO_NATIONAL(GOGOAT), //62
    HOENN_TO_NATIONAL(LITLEO), //63
    HOENN_TO_NATIONAL(PYROAR), //64
    HOENN_TO_NATIONAL(ROGGENROLA), //65
    HOENN_TO_NATIONAL(BOLDORE), //66
    HOENN_TO_NATIONAL(GIGALITH), //67
    HOENN_TO_NATIONAL(ARON), //68
    HOENN_TO_NATIONAL(LAIRON), //69
    HOENN_TO_NATIONAL(AGGRON), //70
    HOENN_TO_NATIONAL(BUDEW), //71
    HOENN_TO_NATIONAL(ROSELIA), //72
    HOENN_TO_NATIONAL(ROSERADE), //73
    HOENN_TO_NATIONAL(TYROGUE), //74
    HOENN_TO_NATIONAL(HITMONLEE), //75
    HOENN_TO_NATIONAL(HITMONCHAN), //76
    HOENN_TO_NATIONAL(HITMONTOP), //77
    HOENN_TO_NATIONAL(ROTOM), //78
};
...
static const u8 sMonFrontAnimIdsTable[NUM_SPECIES - 1] =
{
    ...
    [SPECIES_SKWOVET - 1] = 0x65,
    [SPECIES_GREEDENT - 1] = 0x09,
