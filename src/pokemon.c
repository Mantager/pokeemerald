...
{
    SPECIES_TO_HOENN(CHESPIN), //1
    SPECIES_TO_HOENN(QUILLADIN), //2
    SPECIES_TO_HOENN(CHESNAUGHT), //3
    SPECIES_TO_HOENN(FENNEKIN), //4
    SPECIES_TO_HOENN(BRAIXEN), //5
    SPECIES_TO_HOENN(DELPHOX), //6
    SPECIES_TO_HOENN(FROAKIE), //7
    SPECIES_TO_HOENN(FROGADIER), //8
    SPECIES_TO_HOENN(GRENINJA), //9
    SPECIES_TO_HOENN(RATTATA), //10
    SPECIES_TO_HOENN(RATICATE), //11
    SPECIES_TO_HOENN(PIDOVE), //12
    SPECIES_TO_HOENN(TRANQUILL), //13
    SPECIES_TO_HOENN(UNFEZANT), //14
    SPECIES_TO_HOENN(TAILLOW), //15
    SPECIES_TO_HOENN(SWELLOW), //16
    SPECIES_TO_HOENN(SENTRET), //17
    SPECIES_TO_HOENN(FURRET), //18
    SPECIES_TO_HOENN(PICHU), //19
    SPECIES_TO_HOENN(PIKACHU), //20
    SPECIES_TO_HOENN(RAICHU), //21
    SPECIES_TO_HOENN(AZURILL), //22
    SPECIES_TO_HOENN(MARILL), //23
    SPECIES_TO_HOENN(AZUMARILL), //24
    SPECIES_TO_HOENN(NIDORAN_F), //25
    SPECIES_TO_HOENN(NIDORINA), //26
    SPECIES_TO_HOENN(NIDOQUEEN), //27
    SPECIES_TO_HOENN(NIDORAN_M), //28
    SPECIES_TO_HOENN(NIDORINO), //29
    SPECIES_TO_HOENN(NIDOKING), //30
    SPECIES_TO_HOENN(RALTS), //31
    SPECIES_TO_HOENN(KIRLIA), //32
    SPECIES_TO_HOENN(GARDEVOIR), //33
    SPECIES_TO_HOENN(GALLADE), //34
    SPECIES_TO_HOENN(CATERPIE), //35
    SPECIES_TO_HOENN(METAPOD), //36
    SPECIES_TO_HOENN(BUTTERFREE), //37
    SPECIES_TO_HOENN(WEEDLE), //38
    SPECIES_TO_HOENN(KAKUNA), //39
    SPECIES_TO_HOENN(BEEDRILL), //40
    SPECIES_TO_HOENN(SEWADDLE), //41
    SPECIES_TO_HOENN(SWADLOON), //42
    SPECIES_TO_HOENN(LEAVANNY), //43
    SPECIES_TO_HOENN(VENIPEDE), //44
    SPECIES_TO_HOENN(WHIRLIPEDE), //45
    SPECIES_TO_HOENN(SCOLIPEDE), //46
    SPECIES_TO_HOENN(SLAKOTH), //47
    SPECIES_TO_HOENN(VIGOROTH), //48
    SPECIES_TO_HOENN(SLAKING), //49
    SPECIES_TO_HOENN(MEOWTH), //50
    SPECIES_TO_HOENN(PERSIAN), //51
    SPECIES_TO_HOENN(ABRA), //52
    SPECIES_TO_HOENN(KADABRA), //53
    SPECIES_TO_HOENN(ALAKAZAM), //54
    SPECIES_TO_HOENN(GROWLITHE), //55
    SPECIES_TO_HOENN(ARCANINE), //56
    SPECIES_TO_HOENN(IGGLYBUFF), //57
    SPECIES_TO_HOENN(JIGGLYPUFF), //58
    SPECIES_TO_HOENN(WIGGLYTUFF), //59
    SPECIES_TO_HOENN(PACHIRISU), //60
    SPECIES_TO_HOENN(TRUBBISH), //61
    SPECIES_TO_HOENN(GARBODOR), //62
    SPECIES_TO_HOENN(ZUBAT), //63
    SPECIES_TO_HOENN(GOLBAT), //64
    SPECIES_TO_HOENN(CROBAT), //65
    SPECIES_TO_HOENN(MACHOP), //66
    SPECIES_TO_HOENN(MACHOKE), //67
    SPECIES_TO_HOENN(MACHAMP), //68
    SPECIES_TO_HOENN(SKIDDO), //69
    SPECIES_TO_HOENN(GOGOAT), //70
    SPECIES_TO_HOENN(LITLEO), //71
    SPECIES_TO_HOENN(PYROAR), //72
    SPECIES_TO_HOENN(ROGGENROLA), //73
    SPECIES_TO_HOENN(BOLDORE), //74
    SPECIES_TO_HOENN(GIGALITH), //75
    SPECIES_TO_HOENN(ARON), //76
    SPECIES_TO_HOENN(LAIRON), //77
    SPECIES_TO_HOENN(AGGRON), //78
    SPECIES_TO_HOENN(BUDEW), //79
    SPECIES_TO_HOENN(ROSELIA), //80
    SPECIES_TO_HOENN(ROSERADE), //81
    SPECIES_TO_HOENN(TYROGUE), //82
    SPECIES_TO_HOENN(HITMONLEE), //83
    SPECIES_TO_HOENN(HITMONCHAN), //84
    SPECIES_TO_HOENN(HITMONTOP), //85
    SPECIES_TO_HOENN(ROTOM), //86
};
...
{
    HOENN_TO_NATIONAL(CHESPIN), //1
    HOENN_TO_NATIONAL(QUILLADIN), //2
    HOENN_TO_NATIONAL(CHESNAUGHT), //3
    HOENN_TO_NATIONAL(FENNEKIN), //4
    HOENN_TO_NATIONAL(BRAIXEN), //5
    HOENN_TO_NATIONAL(DELPHOX), //6
    HOENN_TO_NATIONAL(FROAKIE), //7
    HOENN_TO_NATIONAL(FROGADIER), //8
    HOENN_TO_NATIONAL(GRENINJA), //9
    HOENN_TO_NATIONAL(RATTATA), //10
    HOENN_TO_NATIONAL(RATICATE), //11
    HOENN_TO_NATIONAL(PIDOVE), //12
    HOENN_TO_NATIONAL(TRANQUILL), //13
    HOENN_TO_NATIONAL(UNFEZANT), //14
    HOENN_TO_NATIONAL(TAILLOW), //15
    HOENN_TO_NATIONAL(SWELLOW), //16
    HOENN_TO_NATIONAL(SENTRET), //17
    HOENN_TO_NATIONAL(FURRET), //18
    HOENN_TO_NATIONAL(PICHU), //19
    HOENN_TO_NATIONAL(PIKACHU), //20
    HOENN_TO_NATIONAL(RAICHU), //21
    HOENN_TO_NATIONAL(AZURILL), //22
    HOENN_TO_NATIONAL(MARILL), //23
    HOENN_TO_NATIONAL(AZUMARILL), //24
    HOENN_TO_NATIONAL(NIDORAN_F), //25
    HOENN_TO_NATIONAL(NIDORINA), //26
    HOENN_TO_NATIONAL(NIDOQUEEN), //27
    HOENN_TO_NATIONAL(NIDORAN_M), //28
    HOENN_TO_NATIONAL(NIDORINO), //29
    HOENN_TO_NATIONAL(NIDOKING), //30
    HOENN_TO_NATIONAL(RALTS), //31
    HOENN_TO_NATIONAL(KIRLIA), //32
    HOENN_TO_NATIONAL(GARDEVOIR), //33
    HOENN_TO_NATIONAL(GALLADE), //34
    HOENN_TO_NATIONAL(CATERPIE), //35
    HOENN_TO_NATIONAL(METAPOD), //36
    HOENN_TO_NATIONAL(BUTTERFREE), //37
    HOENN_TO_NATIONAL(WEEDLE), //38
    HOENN_TO_NATIONAL(KAKUNA), //39
    HOENN_TO_NATIONAL(BEEDRILL), //40
    HOENN_TO_NATIONAL(SEWADDLE), //41
    HOENN_TO_NATIONAL(SWADLOON), //42
    HOENN_TO_NATIONAL(LEAVANNY), //43
    HOENN_TO_NATIONAL(VENIPEDE), //44
    HOENN_TO_NATIONAL(WHIRLIPEDE), //45
    HOENN_TO_NATIONAL(SCOLIPEDE), //46
    HOENN_TO_NATIONAL(SLAKOTH), //47
    HOENN_TO_NATIONAL(VIGOROTH), //48
    HOENN_TO_NATIONAL(SLAKING), //49
    HOENN_TO_NATIONAL(MEOWTH), //50
    HOENN_TO_NATIONAL(PERSIAN), //51
    HOENN_TO_NATIONAL(ABRA), //52
    HOENN_TO_NATIONAL(KADABRA), //53
    HOENN_TO_NATIONAL(ALAKAZAM), //54
    HOENN_TO_NATIONAL(GROWLITHE), //55
    HOENN_TO_NATIONAL(ARCANINE), //56
    HOENN_TO_NATIONAL(IGGLYBUFF), //57
    HOENN_TO_NATIONAL(JIGGLYPUFF), //58
    HOENN_TO_NATIONAL(WIGGLYTUFF), //59
    HOENN_TO_NATIONAL(PACHIRISU), //60
    HOENN_TO_NATIONAL(TRUBBISH), //61
    HOENN_TO_NATIONAL(GARBODOR), //62
    HOENN_TO_NATIONAL(ZUBAT), //63
    HOENN_TO_NATIONAL(GOLBAT), //64
    HOENN_TO_NATIONAL(CROBAT), //65
    HOENN_TO_NATIONAL(MACHOP), //66
    HOENN_TO_NATIONAL(MACHOKE), //67
    HOENN_TO_NATIONAL(MACHAMP), //68
    HOENN_TO_NATIONAL(SKIDDO), //69
    HOENN_TO_NATIONAL(GOGOAT), //70
    HOENN_TO_NATIONAL(LITLEO), //71
    HOENN_TO_NATIONAL(PYROAR), //72
    HOENN_TO_NATIONAL(ROGGENROLA), //73
    HOENN_TO_NATIONAL(BOLDORE), //74
    HOENN_TO_NATIONAL(GIGALITH), //75
    HOENN_TO_NATIONAL(ARON), //76
    HOENN_TO_NATIONAL(LAIRON), //77
    HOENN_TO_NATIONAL(AGGRON), //78
    HOENN_TO_NATIONAL(BUDEW), //79
    HOENN_TO_NATIONAL(ROSELIA), //80
    HOENN_TO_NATIONAL(ROSERADE), //81
    HOENN_TO_NATIONAL(TYROGUE), //82
    HOENN_TO_NATIONAL(HITMONLEE), //83
    HOENN_TO_NATIONAL(HITMONCHAN), //84
    HOENN_TO_NATIONAL(HITMONTOP), //85
    HOENN_TO_NATIONAL(ROTOM), //86
};
