...
static void PlayerPartnerHandleDrawTrainerPic(void)
{
    ...
    if (gPartnerTrainerId == TRAINER_STEVEN_PARTNER || gPartnerTrainerId == TRAINER_FERN_PARTNER || gPartnerTrainerId >= TRAINER_CUSTOM_PARTNER)
    {
...
static void PlayerPartnerHandleIntroTrainerBallThrow(void)
{
    ...
    if (gPartnerTrainerId == TRAINER_STEVEN_PARTNER || gPartnerTrainerId == TRAINER_FERN_PARTNER)
    {
