...
static const u8 gRegionMapSectionId_To_PopUpThemeIdMapping[] =
{
    ...
    [MAPSEC_ORACLE_HILL - KANTO_MAPSEC_COUNT] = MAPPOPUP_THEME_WOOD,
    [MAPSEC_LINKING_TUNNEL - KANTO_MAPSEC_COUNT] = MAPPOPUP_THEME_STONE,
    [MAPSEC_TIYU_FOREST - KANTO_MAPSEC_COUNT] = MAPPOPUP_THEME_WOOD,
    [MAPSEC_DARK_CITY - KANTO_MAPSEC_COUNT] = MAPPOPUP_THEME_STONE,
    [MAPSEC_DARK_RUINS - KANTO_MAPSEC_COUNT] = MAPPOPUP_THEME_STONE,
    [MAPSEC_ZHAOUN_PATH - KANTO_MAPSEC_COUNT] = MAPPOPUP_THEME_UNDERWATER,
