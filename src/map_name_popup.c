...
static const u8 gRegionMapSectionId_To_PopUpThemeIdMapping[] =
{
    ...
    [MAPSEC_SYDNEY_CITY] = MAPPOPUP_THEME_STONE,
    [MAPSEC_STARGAZE_POINT] = MAPPOPUP_THEME_WOOD,
    [MAPSEC_FABLE_SQUARE] = MAPPOPUP_THEME_STONE,
    [MAPSEC_DOTSY_CITY] = MAPPOPUP_THEME_STONE,
    [MAPSEC_OAKEN_CITY] = MAPPOPUP_THEME_WOOD,
    [MAPSEC_ROUTE_1] = MAPPOPUP_THEME_WOOD,
    [MAPSEC_ROUTE_2] = MAPPOPUP_THEME_WOOD,
    [MAPSEC_ROUTE_3_NORTH] = MAPPOPUP_THEME_WOOD,
    [MAPSEC_ROUTE_3_SOUTH] = MAPPOPUP_THEME_WOOD,
    [MAPSEC_TWISTED_WOODS] = MAPPOPUP_THEME_WOOD,
    [MAPSEC_GLOOMY_CAVERN] = MAPPOPUP_THEME_STONE2,
