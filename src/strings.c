...
const u8 gText_DexHoennTitle[] = _("Tomen Dex");
...
const u8 gText_DexHoennDescription[] = _("Tomen region's Pokédex");
...
const u8 gText_CheckMapOfHoenn[] = _("Check the map of the Tomen region.");
...
const u8 gText_DexHoenn[] = _("Tomen");
...
const u8 gText_PleaseSetTheTime[] = _("Please set up the time.");
