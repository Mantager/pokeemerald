...
static const struct TrainerMonItemDefaultMoves sParty_Guowei[] = {
    {
    .iv = 100,
    .lvl = 21,
...
static const struct TrainerMonItemDefaultMoves sParty_Huizhong[] = {
    {
    .iv = 100,
    .lvl = 21,
...
static const struct TrainerMonItemDefaultMoves sParty_Baozhai[] = {
    {
    .iv = 0,
    .lvl = 25,
...
static const struct TrainerMonItemCustomMoves sParty_Log2[] = {
    ...
    .species = SPECIES_GRAVELER,
    .heldItem = ITEM_RINDO_BERRY,
    .moves = {MOVE_STEALTH_ROCK, MOVE_BULLDOZE, MOVE_SMACK_DOWN, MOVE_DOUBLE_EDGE},
    .abilityNum = 0
    },
    {
    .iv = 150,
    ...
    .heldItem = ITEM_SHUCA_BERRY,
    .moves = {MOVE_DISCHARGE, MOVE_MUD_BOMB, MOVE_BOUNCE, MOVE_MUDDY_WATER},
    .abilityNum = 0
    },
    {
    .iv = 150,
    ...
    .species = SPECIES_BIBAREL,
    .heldItem = ITEM_WACAN_BERRY,
    .moves = {MOVE_YAWN, MOVE_HYPER_FANG, MOVE_SWORDS_DANCE, MOVE_ROLLOUT},
    .abilityNum = 2
    },
    {
    .iv = 150,
