const struct Trainer gTrainers[] = {
    ...
    [TRAINER_LING] =
    {
        ...
        .trainerName = _("Ling"),
        #else
        .trainerName = _("{JPN}リーン"),
        #endif
        .items = {},
        .doubleBattle = FALSE,
        .aiFlags = AI_SCRIPT_CHECK_BAD_MOVE | AI_SCRIPT_TRY_TO_FAINT | AI_SCRIPT_CHECK_VIABILITY,
        .partySize = ARRAY_COUNT(sParty_Ling),
        .party = {.ItemDefaultMoves = sParty_Ling},
    },
    ...
    [TRAINER_BAI] =
    {
        ...
        .trainerName = _("Bai"),
        #else
        .trainerName = _("{JPN}バイ"),
        #endif
        .items = {},
        .doubleBattle = FALSE,
        .aiFlags = AI_SCRIPT_CHECK_BAD_MOVE | AI_SCRIPT_TRY_TO_FAINT | AI_SCRIPT_CHECK_VIABILITY,
        .partySize = ARRAY_COUNT(sParty_Bai),
        .party = {.ItemDefaultMoves = sParty_Bai},
    },
    ...
    [TRAINER_HONG] =
    {
        ...
        .trainerName = _("Hong"),
        #else
        .trainerName = _("{JPN}ホーン"),
        #endif
        .items = {},
        .doubleBattle = FALSE,
        .aiFlags = AI_SCRIPT_CHECK_BAD_MOVE | AI_SCRIPT_TRY_TO_FAINT | AI_SCRIPT_CHECK_VIABILITY,
        .partySize = ARRAY_COUNT(sParty_Hong),
        .party = {.ItemDefaultMoves = sParty_Hong},
    },
    ...
    [TRAINER_LOG_1] =
    {
        ...
        .trainerName = _("Log"),
        #else
        .trainerName = _("{JPN}ロッグ"),
        #endif
        .items = {},
        .doubleBattle = FALSE,
        .aiFlags = AI_SCRIPT_CHECK_BAD_MOVE | AI_SCRIPT_TRY_TO_FAINT | AI_SCRIPT_CHECK_VIABILITY,
        .partySize = ARRAY_COUNT(sParty_Log1),
        .party = {.ItemDefaultMoves = sParty_Log1},
    },
    ...
    [TRAINER_FAN] =
    {
        ...
        .trainerName = _("Fan"),
        #else
        .trainerName = _("{JPN}ファン"),
        #endif
        .items = {},
        .doubleBattle = FALSE,
        .aiFlags = AI_SCRIPT_CHECK_BAD_MOVE | AI_SCRIPT_TRY_TO_FAINT | AI_SCRIPT_CHECK_VIABILITY,
        .partySize = ARRAY_COUNT(sParty_Fan),
        .party = {.ItemDefaultMoves = sParty_Fan},
    },
    ...
    [TRAINER_BOLIN] =
    {
        ...
        .trainerName = _("Bolin"),
        #else
        .trainerName = _("{JPN}バイリン"),
        #endif
        .items = {},
        .doubleBattle = FALSE,
        .aiFlags = AI_SCRIPT_CHECK_BAD_MOVE | AI_SCRIPT_TRY_TO_FAINT | AI_SCRIPT_CHECK_VIABILITY,
        .partySize = ARRAY_COUNT(sParty_Bolin),
        .party = {.ItemDefaultMoves = sParty_Bolin},
    },
    ...
    [TRAINER_CHANGPU] =
    {
        ...
        #ifdef ENGLISH
        .trainerName = _("Changpu"),
        #else
        .trainerName = _("{JPN}チャーンプゥ"),
        #endif
        .items = {},
        .doubleBattle = FALSE,
        .aiFlags = AI_SCRIPT_CHECK_BAD_MOVE | AI_SCRIPT_TRY_TO_FAINT | AI_SCRIPT_CHECK_VIABILITY,
        .partySize = ARRAY_COUNT(sParty_Changpu),
        .party = {.ItemDefaultMoves = sParty_Changpu},
    },
    ...
    [TRAINER_KANG] =
    {
        ...
        .trainerName = _("Kang"),
        #else
        .trainerName = _("{JPN}カーン"),
        #endif
        .items = {},
        .doubleBattle = FALSE,
        .aiFlags = AI_SCRIPT_CHECK_BAD_MOVE | AI_SCRIPT_TRY_TO_FAINT | AI_SCRIPT_CHECK_VIABILITY,
        .partySize = ARRAY_COUNT(sParty_Kang),
        .party = {.ItemDefaultMoves = sParty_Kang},
    },

    [TRAINER_DANDAN] =
    {
        .partyFlags = F_TRAINER_PARTY_HELD_ITEM,
        .trainerClass = TRAINER_CLASS_TAILOR,
        .encounterMusic_gender = F_TRAINER_FEMALE | TRAINER_ENCOUNTER_MUSIC_FEMALE,
        .trainerPic = TRAINER_PIC_TAILOR,
        #ifdef ENGLISH
        .trainerName = _("Dandan"),
        #else
        .trainerName = _("{JPN}ダンダン"),
        #endif
        .items = {},
        .doubleBattle = FALSE,
        .aiFlags = AI_SCRIPT_CHECK_BAD_MOVE | AI_SCRIPT_TRY_TO_FAINT | AI_SCRIPT_CHECK_VIABILITY,
        .partySize = ARRAY_COUNT(sParty_Dandan),
        .party = {.ItemDefaultMoves = sParty_Dandan},
    },
    ...
    [TRAINER_XIU] =
    {
        ...
        .trainerName = _("Xiu"),
        #else
        .trainerName = _("{JPN}シウ"),
        #endif
        .items = {},
        .doubleBattle = FALSE,
        .aiFlags = AI_SCRIPT_CHECK_BAD_MOVE | AI_SCRIPT_TRY_TO_FAINT | AI_SCRIPT_CHECK_VIABILITY,
        .partySize = ARRAY_COUNT(sParty_Xiu),
        .party = {.ItemDefaultMoves = sParty_Xiu},
    },
    ...
    [TRAINER_GEN] =
    {
        ...
        .doubleBattle = FALSE,
        .aiFlags = AI_SCRIPT_CHECK_BAD_MOVE | AI_SCRIPT_TRY_TO_FAINT | AI_SCRIPT_CHECK_VIABILITY,
        .partySize = ARRAY_COUNT(sParty_Gen),
        .party = {.ItemDefaultMoves = sParty_Gen},
    },
    ...
    [TRAINER_NIAN] =
    {
        ...
        .trainerName = _("Nian"),
        #else
        .trainerName = _("{JPN}ニエン"),
        #endif
        .items = {},
        .doubleBattle = FALSE,
        .aiFlags = AI_SCRIPT_CHECK_BAD_MOVE | AI_SCRIPT_TRY_TO_FAINT | AI_SCRIPT_CHECK_VIABILITY,
        .partySize = ARRAY_COUNT(sParty_Nian),
        .party = {.ItemDefaultMoves = sParty_Nian},
    },
    ...
    [TRAINER_SHI] =
    {
        ...
        .trainerName = _("Shi"),
        #else
        .trainerName = _("{JPN}シー"),
        #endif
        .items = {},
        .doubleBattle = FALSE,
        .aiFlags = AI_SCRIPT_CHECK_BAD_MOVE | AI_SCRIPT_TRY_TO_FAINT | AI_SCRIPT_CHECK_VIABILITY,
        .partySize = ARRAY_COUNT(sParty_Shi),
        .party = {.ItemDefaultMoves = sParty_Shi},
    },
    ...
    [TRAINER_PING] =
    {
        ...
        .trainerName = _("Ping"),
        #else
        .trainerName = _("{JPN}ピーン"),
        #endif
        .items = {},
        .doubleBattle = FALSE,
        .aiFlags = AI_SCRIPT_CHECK_BAD_MOVE | AI_SCRIPT_TRY_TO_FAINT | AI_SCRIPT_CHECK_VIABILITY,
        .partySize = ARRAY_COUNT(sParty_Ping),
        .party = {.ItemDefaultMoves = sParty_Ping},
    },
    ...
    [TRAINER_CHUNTAO] =
    {
        ...
        .trainerPic = TRAINER_PIC_TAILOR,
        #ifdef ENGLISH
        .trainerName = _("Chuntao"),
        #else
        .trainerName = _("{JPN}チュンタオ"),
        #endif
        .items = {},
        .doubleBattle = FALSE,
        .aiFlags = AI_SCRIPT_CHECK_BAD_MOVE | AI_SCRIPT_TRY_TO_FAINT | AI_SCRIPT_CHECK_VIABILITY,
        .partySize = ARRAY_COUNT(sParty_Chuntao),
        .party = {.ItemDefaultMoves = sParty_Chuntao},
    },
    ...
    [TRAINER_DAIYU] =
    {
        ...
        .trainerName = _("Daiyu"),
        #else
        .trainerName = _("{JPN}ダイユイ"),
        #endif
        .items = {},
        .doubleBattle = FALSE,
        .aiFlags = AI_SCRIPT_CHECK_BAD_MOVE | AI_SCRIPT_TRY_TO_FAINT | AI_SCRIPT_CHECK_VIABILITY,
        .partySize = ARRAY_COUNT(sParty_Daiyu),
        .party = {.ItemDefaultMoves = sParty_Daiyu},
    },
    ...
    [TRAINER_PENGFEI] =
    {
        ...
        #ifdef ENGLISH
        .trainerName = _("Pengfei"),
        #else
        .trainerName = _("{JPN}プオンフェイ"),
        #endif
        .items = {},
        .doubleBattle = FALSE,
        .aiFlags = AI_SCRIPT_CHECK_BAD_MOVE | AI_SCRIPT_TRY_TO_FAINT | AI_SCRIPT_CHECK_VIABILITY,
        .partySize = ARRAY_COUNT(sParty_Pengfei),
        .party = {.ItemDefaultMoves = sParty_Pengfei},
    },
    ...
    [TRAINER_YAO] =
    {
        ...
        .trainerName = _("Yao"),
        #else
        .trainerName = _("{JPN}ヤオ"),
        #endif
        .items = {},
        .doubleBattle = FALSE,
        .aiFlags = AI_SCRIPT_CHECK_BAD_MOVE | AI_SCRIPT_TRY_TO_FAINT | AI_SCRIPT_CHECK_VIABILITY,
        .partySize = ARRAY_COUNT(sParty_Yao),
        .party = {.ItemDefaultMoves = sParty_Yao},
    },
    ...
    [TRAINER_LU] =
    {
        ...
        .trainerName = _("Lu"),
        #else
        .trainerName = _("{JPN}ルゥ"),
        #endif
        .items = {},
        .doubleBattle = FALSE,
        .aiFlags = AI_SCRIPT_CHECK_BAD_MOVE | AI_SCRIPT_TRY_TO_FAINT | AI_SCRIPT_CHECK_VIABILITY,
        .partySize = ARRAY_COUNT(sParty_Lu),
        .party = {.ItemDefaultMoves = sParty_Lu},
    },
    ...
    [TRAINER_RUE] =
    {
        ...
        .trainerName = _("Rue"),
        #else
        .trainerName = _("{JPN}ゥルイ"),
        #endif
        .items = {},
        .doubleBattle = FALSE,
        .aiFlags = AI_SCRIPT_CHECK_BAD_MOVE | AI_SCRIPT_TRY_TO_FAINT | AI_SCRIPT_CHECK_VIABILITY,
        .partySize = ARRAY_COUNT(sParty_Rue),
        .party = {.ItemDefaultMoves = sParty_Rue},
    },

    [TRAINER_ARUM] =
    {
        .partyFlags = F_TRAINER_PARTY_HELD_ITEM | F_TRAINER_PARTY_CUSTOM_MOVESET,
        .trainerClass = TRAINER_CLASS_KEEPER,
        .encounterMusic_gender = TRAINER_ENCOUNTER_MUSIC_COOL,
        .trainerPic = TRAINER_PIC_KEEPER,
        #ifdef ENGLISH
        .trainerName = _("Arum"),
        #else
        .trainerName = _("{JPN}アルム"),
        #endif
        .items = {ITEM_ENERGY_ROOT, ITEM_NONE, ITEM_NONE, ITEM_NONE},
        .doubleBattle = FALSE,
        .aiFlags = AI_SCRIPT_CHECK_BAD_MOVE | AI_SCRIPT_TRY_TO_FAINT | AI_SCRIPT_CHECK_VIABILITY,
        .partySize = ARRAY_COUNT(sParty_Arum),
        .party = {.ItemCustomMoves = sParty_Arum},
    },
    ...
    [TRAINER_LOG_2] =
    {
        ...
        .doubleBattle = FALSE,
        .aiFlags = AI_SCRIPT_CHECK_BAD_MOVE | AI_SCRIPT_TRY_TO_FAINT | AI_SCRIPT_CHECK_VIABILITY,
        .partySize = ARRAY_COUNT(sParty_Log2),
        .party = {.ItemCustomMoves = sParty_Log2},
    },
    ...
    [TRAINER_GUOWEI] =
    {
        ...
        #ifdef ENGLISH
        .trainerName = _("Guowei"),
        #else
        .trainerName = _("{JPN}グオウエイ"),
        #endif
        .items = {},
        .doubleBattle = FALSE,
        .aiFlags = AI_SCRIPT_CHECK_BAD_MOVE | AI_SCRIPT_TRY_TO_FAINT | AI_SCRIPT_CHECK_VIABILITY,
        .partySize = ARRAY_COUNT(sParty_Guowei),
        .party = {.ItemDefaultMoves = sParty_Guowei},
    },
    ...
    [TRAINER_HUIZHONG] =
    {
        ...
        #ifdef ENGLISH
        .trainerName = _("Huizhong"),
        #else
        .trainerName = _("{JPN}ホゥイジョーン"),
        #endif
        .items = {},
        .doubleBattle = FALSE,
        .aiFlags = AI_SCRIPT_CHECK_BAD_MOVE | AI_SCRIPT_TRY_TO_FAINT | AI_SCRIPT_CHECK_VIABILITY,
        .partySize = ARRAY_COUNT(sParty_Huizhong),
        .party = {.ItemDefaultMoves = sParty_Huizhong},
    },
    ...
    [TRAINER_BAOZHAI] =
    {
        ...
        #ifdef ENGLISH
        .trainerName = _("Baozhai"),
        #else
        .trainerName = _("{JPN}バオチャイ"),
        #endif
        .items = {},
        .doubleBattle = FALSE,
        .aiFlags = AI_SCRIPT_CHECK_BAD_MOVE | AI_SCRIPT_TRY_TO_FAINT | AI_SCRIPT_CHECK_VIABILITY,
        .partySize = ARRAY_COUNT(sParty_Baozhai),
        .party = {.ItemDefaultMoves = sParty_Baozhai},
    },

    // Gaiden 1 trainers end here.
