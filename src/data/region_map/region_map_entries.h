...
const struct RegionMapLocation gRegionMapEntries[] = {
    ...
    [MAPSEC_SYDNEY_CITY]               = { 0,  0, 1, 1, sMapName_SydneyCity},
    [MAPSEC_FABLE_SQUARE]              = { 0,  0, 1, 1, sMapName_FableSquare},
    [MAPSEC_DOTSY_CITY]                = { 0,  0, 1, 1, sMapName_DotsyCity},
    [MAPSEC_OAKEN_CITY]                = { 0,  0, 1, 1, sMapName_OakenCity},
    [MAPSEC_STARGAZE_POINT]            = { 0,  0, 1, 1, sMapName_StargazePoint},
    [MAPSEC_TWISTED_WOODS]             = { 0,  0, 1, 1, sMapName_TwistedWoods},
    [MAPSEC_GLOOMY_CAVERN]             = { 0,  0, 1, 1, sMapName_GloomyCavern},
    [MAPSEC_TRAINING_GROUND]           = { 0,  0, 1, 1, sMapName_TrainingGround},
    [MAPSEC_DOTSY_SEWERS]              = { 0,  0, 1, 1, sMapName_DotsySewers},
