...
const struct ObjectEventGraphicsInfo *const gObjectEventGraphicsInfoPointers[NUM_OBJ_EVENT_GFX] = {
    ...
    [OBJ_EVENT_GFX_MALIMO] =                   &gObjectEventGraphicsInfo_Sidney,
    [OBJ_EVENT_GFX_FERN] =                     &gObjectEventGraphicsInfo_Phoebe,
    [OBJ_EVENT_GFX_RYAN] =                     &gObjectEventGraphicsInfo_Glacia,
    [OBJ_EVENT_GFX_NAS] =                      &gObjectEventGraphicsInfo_Drake,
    [OBJ_EVENT_GFX_WAILMER] =                  &gObjectEventGraphicsInfo_Wailmer,
    [OBJ_EVENT_GFX_MISLE] =                    &gObjectEventGraphicsInfo_Brawly,
