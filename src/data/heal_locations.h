static const struct HealLocation sHealLocations[] =
{
    ...
    {MAP_GROUP(JAM_KEY_MAP), MAP_NUM(JAM_KEY_MAP), 26, 22},
    {MAP_GROUP(CHO_VILLAGE), MAP_NUM(CHO_VILLAGE), 23, 4},
    {MAP_GROUP(DARK_CITY_ENTRANCE), MAP_NUM(DARK_CITY_ENTRANCE), 14, 39},
    {MAP_GROUP(DARK_CITY_MAIN), MAP_NUM(DARK_CITY_MAIN), 29, 21},
};
