static const struct HealLocation sHealLocations[] =
{
    ...
    {MAP_GROUP(SYDNEY_CITY), MAP_NUM(SYDNEY_CITY), 7, 17},
    {MAP_GROUP(FABLE_SQUARE), MAP_NUM(FABLE_SQUARE), 12, 16},
    {MAP_GROUP(SYDNEY_CITY_PLAYERS_HOUSE_2F), MAP_NUM(SYDNEY_CITY_PLAYERS_HOUSE_2F), 2, 6},
    {MAP_GROUP(DOTSY_CITY), MAP_NUM(DOTSY_CITY), 21, 43},
    {MAP_GROUP(OAKEN_CITY), MAP_NUM(OAKEN_CITY), 4, 7},
};
