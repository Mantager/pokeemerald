static const struct HealLocation sHealLocations[] =
{
    ...
    [HEAL_LOCATION_PRIME_CITY - 1] = {MAP_GROUP(PRIME_CITY), MAP_NUM(PRIME_CITY), 34, 48},
    [HEAL_LOCATION_YANURAS_TOWN - 1] = {MAP_GROUP(YANURAS_TOWN), MAP_NUM(YANURAS_TOWN), 19, 12},
    [HEAL_LOCATION_ROCAROHA_VALLEY - 1] = {MAP_GROUP(ROCAROHA_VALLEY), MAP_NUM(ROCAROHA_VALLEY), 8, 10},
    [HEAL_LOCATION_DELAGUA_TOWN - 1] = {MAP_GROUP(DELAGUA_TOWN), MAP_NUM(DELAGUA_TOWN), 10, 30},
    [HEAL_LOCATION_ORO_TOWN - 1] = {MAP_GROUP(ORO_TOWN), MAP_NUM(ORO_TOWN), 11, 25},
    [HEAL_LOCATION_PISTA_VILLAGE - 1] = {MAP_GROUP(PISTA_VILLAGE), MAP_NUM(PISTA_VILLAGE), 4, 12},
    [HEAL_LOCATION_WING_PEAK_TOP - 1] = {MAP_GROUP(WING_PEAK_TOP), MAP_NUM(WING_PEAK_TOP), 13, 34},
    [HEAL_LOCATION_PRIME_CITY_CLAD_BUILDING_3F_CLAD_ROOM - 1] = {MAP_GROUP(PRIME_CITY_CLAD_BUILDING_3F_CLAD_ROOM), MAP_NUM(PRIME_CITY_CLAD_BUILDING_3F_CLAD_ROOM), 2, 4},
};
