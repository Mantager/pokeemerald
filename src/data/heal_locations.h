static const struct HealLocation sHealLocations[] =
{
    ...
    {MAP_GROUP(CAESAR_TOWN), MAP_NUM(CAESAR_TOWN), 0, 0},
    {MAP_GROUP(LANCEL_CITY), MAP_NUM(LANCEL_CITY), 0, 0},
    {MAP_GROUP(ARC_TOWN), MAP_NUM(ARC_TOWN), 0, 0},
    {MAP_GROUP(BONNEY_CITY), MAP_NUM(BONNEY_CITY), 0, 0},
    {MAP_GROUP(MEDES_TOWN), MAP_NUM(MEDES_TOWN), 0, 0},
    {MAP_GROUP(HEPBURN_CITY), MAP_NUM(HEPBURN_CITY), 0, 0},
    {MAP_GROUP(GOFF_TOWN), MAP_NUM(GOFF_TOWN), 0, 0},
    {MAP_GROUP(NIEL_CITY), MAP_NUM(NIEL_CITY), 0, 0},
    {MAP_GROUP(HEMING_CITY), MAP_NUM(HEMING_CITY), 0, 0},
    {MAP_GROUP(REMANT_CITY), MAP_NUM(REMANT_CITY), 0, 0},
    {MAP_GROUP(TOLKET_TOWN), MAP_NUM(TOLKET_TOWN), 0, 0},
    {MAP_GROUP(FROOD_TOWN), MAP_NUM(FROOD_TOWN), 0, 0},
    {MAP_GROUP(DARWIN_CITY), MAP_NUM(DARWIN_CITY), 0, 0},
    {MAP_GROUP(WONDER_CITY), MAP_NUM(WONDER_CITY), 0, 0},
    {MAP_GROUP(POKEMON_LEAGUE), MAP_NUM(POKEMON_LEAGUE), 0, 0},
};
