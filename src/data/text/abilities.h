...
static const u8 sStenchDescription[] = _("Decreases the chance of\nencountering Pokémon.");
static const u8 sDrizzleDescription[] = _("Summons rain upon\nentering battle.");
static const u8 sSpeedBoostDescription[] = _("Speed increases at the\nend of each turn.");
static const u8 sBattleArmorDescription[] = _("Armor protects it from\ncritical hits.");
static const u8 sSturdyDescription[] = _("Cannot be knocked out in\none hit.");
static const u8 sDampDescription[] = _("Suppresses explosive\nattacks.");
static const u8 sLimberDescription[] = _("The Pokémon cannot become\nparalysed.");
static const u8 sSandVeilDescription[] = _("Evasion increases in a\nsandstorm.");
static const u8 sStaticDescription[] = _("Attackers making contact\nmay become paralysed.");
static const u8 sVoltAbsorbDescription[] = _("Being hit by Electric\nattacks restores HP.");
static const u8 sWaterAbsorbDescription[] = _("Being hit by Water\nattacks restores HP.");
static const u8 sObliviousDescription[] = _("The Pokémon cannot be\ninfatuated or taunted.");
static const u8 sCloudNineDescription[] = _("Weather is negated whilst\nthis Pokémon is out.");
static const u8 sCompoundEyesDescription[] = _("The Pokémon's accuracy is\nboosted.");
static const u8 sInsomniaDescription[] = _("The Pokémon cannot fall\nasleep.");
static const u8 sColorChangeDescription[] = _("When hit by a move,\ntype changes to match.");
static const u8 sImmunityDescription[] = _("The Pokémon cannot become\npoisoned.");
static const u8 sFlashFireDescription[] = _("Powers up Fire moves if\nhit by Fire moves.");
static const u8 sShieldDustDescription[] = _("Blocks the added effects\nof attacks taken.");
static const u8 sOwnTempoDescription[] = _("The Pokémon cannot become\nconfused.");
...
static const u8 sWaterVeilDescription[] = _("The Pokémon cannot\nbe burned.");
