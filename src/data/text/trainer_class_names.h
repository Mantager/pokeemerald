const u8 gTrainerClassNames[][13] = {
    ...
    [TRAINER_CLASS_TAILOR] = _("Tailor"),
    [TRAINER_CLASS_KEEPER] = _("Keeper"),
    [TRAINER_CLASS_WU] = _("Wu"),
#else
    ...
    [TRAINER_CLASS_BUG_MANIAC] = _("{JPN}こんちゅうマニア"),
    ...
    [TRAINER_CLASS_ENGINEER] = _("{JPN}エンジニア"),
    [TRAINER_CLASS_FARMER] = _("{JPN}ぼくじょうおじさん"),
    [TRAINER_CLASS_TAILOR] = _("{JPN}ようさいし"),
    [TRAINER_CLASS_KEEPER] = _("{JPN}ほゆうしゃ"),
    [TRAINER_CLASS_WU] = _("{JPN}かんなぎ")
#endif
};
