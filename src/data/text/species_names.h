const u8 gSpeciesNames[][POKEMON_NAME_LENGTH + 1] = {
    ...
    [SPECIES_CHERUBI] = _("{JPN}チェリンボ"),
    [SPECIES_CHERRIM] = _("{JPN}チェリム"),
    [SPECIES_PANCHAM] = _("{JPN}ヤンチャム"),
    [SPECIES_PANGORO] = _("{JPN}ゴロンダ"),
    [SPECIES_FOONGUS] = _("{JPN}タマゲタケ"),
    [SPECIES_AMOONGUSS] = _("{JPN}モロバレル"),
    ...
    [SPECIES_TYMPOLE] = _("{JPN}オタマロ"),
    [SPECIES_PALPITOAD] = _("{JPN}ガマガル"),
    [SPECIES_SEISMITOAD] = _("{JPN}ガマゲロゲ"),
    ...
    [SPECIES_CROAGUNK] = _("{JPN}グレッグル"),
    [SPECIES_TOXICROAK] = _("{JPN}ドクロッグ"),
    [SPECIES_BIDOOF] = _("{JPN}ビッパ"),
    [SPECIES_BIBAREL] = _("{JPN}ビーダル"),
    [SPECIES_CARNIVINE] = _("{JPN}マスキッパ"),
    [SPECIES_GOOMY] = _("{JPN}ヌメラ"),
    [SPECIES_SLIGGOO] = _("{JPN}ヌメイル"),
    [SPECIES_GOODRA] = _("{JPN}ヌメルゴン"),
    ...
    [SPECIES_YAMASK] = _("{JPN}デスマス"),
    [SPECIES_COFAGRIGUS] = _("{JPN}デスカーン"),
    [SPECIES_WOOBAT] = _("{JPN}コロモリ"),
    [SPECIES_SWOOBAT] = _("{JPN}ココロモリ"),
    [SPECIES_MACHOP] = _("{JPN}ワンリキー"),
    [SPECIES_MACHOKE] = _("{JPN}ゴーリキー"),
    [SPECIES_MACHAMP] = _("{JPN}カイリキー"),
    [SPECIES_TIMBURR] = _("{JPN}ドッコラー"),
    [SPECIES_GURDURR] = _("{JPN}ドテッコツ"),
    [SPECIES_CONKELDURR] = _("{JPN}ローブシン"),
