...
const u32 gItemIcon_MantaCharm[] = INCBIN_U32("graphics/items/icons/manta_charm.4bpp.lz");
const u32 gItemIconPalette_MantaCharm[] = INCBIN_U32("graphics/items/icon_palettes/manta_charm.gbapal.lz");