...
const u32 gTrainerFrontPic_WildYoungster[] = INCBIN_U32("graphics/trainers/front_pics/wild_youngster_front_pic.4bpp.lz");
const u32 gTrainerPalette_WildYoungster[] = INCBIN_U32("graphics/trainers/palettes/wild_youngster.gbapal.lz");
