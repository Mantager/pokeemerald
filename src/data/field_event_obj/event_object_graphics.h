...
const u32 gEventObjectPic_Log[] = INCBIN_U32("graphics/event_objects/pics/people/log.4bpp");
const u16 gEventObjectPalette35[] = INCBIN_U16("graphics/event_objects/palettes/field_object_palette_35.gbapal");
const u32 gEventObjectPic_Diglett[] = INCBIN_U32("graphics/event_objects/pics/pokemon/diglett.4bpp");
