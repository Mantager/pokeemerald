...
#define VAR_PRIME_CITY_STATE                 0x404E // Used to track story progress in Prime City
#define VAR_LOTAD_SIZE_RECORD                0x404F
#define VAR_LITTLEROOT_TOWN_STATE            0x4050
#define VAR_OLDALE_TOWN_STATE                0x4051
#define VAR_YANURAS_TOWN_STATE               0x4052 // Used to track story progress in Yanuras Town
#define VAR_LAVARIDGE_TOWN_STATE             0x4053
#define VAR_CURRENT_SECRET_BASE              0x4054 // was probably allocated for VAR_FALLARBOR_TOWN_STATE at one point
#define VAR_ORO_TOWN_STATE                   0x4055 // Used to track story progress in Oro Town
#define VAR_PISTA_VILLAGE_STATE              0x4056 // Used to track story progress in Pista Village
#define VAR_PETALBURG_CITY_STATE             0x4057
#define VAR_SLATEPORT_CITY_STATE             0x4058
#define VAR_MEMLINK_OPPONENT                 0x4059 // Unused Var
...
#define VAR_NUMBER_OF_WHITEOUTS              0x40F7
