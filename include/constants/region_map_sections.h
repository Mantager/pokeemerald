...
#define MAPSEC_YANURAS_TOWN                 0xD6
#define MAPSEC_DELAGUA_TOWN                 0xD7
#define MAPSEC_ORO_TOWN                     0xD8
#define MAPSEC_PISTA_VILLAGE                0xD9
#define MAPSEC_NEW_VALLEY_WAY               0xDA
#define MAPSEC_ROCAROHA_VALLEY              0xDB
#define MAPSEC_DERIVA_WALK                  0xDC
#define MAPSEC_LAND_BRIDGE_SOUTH            0xDD
#define MAPSEC_LAND_BRIDGE_NORTH            0xDE
#define MAPSEC_VIENTO_WALK                  0xDF
