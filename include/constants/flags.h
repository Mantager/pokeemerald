...
#define FLAG_HIDDEN_ITEM_FARMER_HUT_SITRUS_BERRY             (FLAG_HIDDEN_ITEMS_START + 0x01)
#define FLAG_HIDDEN_ITEM_FARMER_HUT_REVIVAL_HERB             (FLAG_HIDDEN_ITEMS_START + 0x08)
#define FLAG_HIDDEN_ITEM_PULP_BYROAD_ORAN_BERRY              (FLAG_HIDDEN_ITEMS_START + 0x09)
#define FLAG_HIDDEN_ITEM_PULP_BYROAD_HEAL_POWDER             (FLAG_HIDDEN_ITEMS_START + 0x0A)
#define FLAG_HIDDEN_ITEM_PULP_BYROAD_RAWST_BERRY             (FLAG_HIDDEN_ITEMS_START + 0x0B)
#define FLAG_HIDDEN_ITEM_PULP_BYROAD_PECHA_BERRY             (FLAG_HIDDEN_ITEMS_START + 0x0D)
#define FLAG_HIDDEN_ITEM_PULP_FIELD_BABIRI_BERRY             (FLAG_HIDDEN_ITEMS_START + 0x24)
#define FLAG_HIDDEN_ITEM_SHENDOWN_PATH_RINDO_BERRY           (FLAG_HIDDEN_ITEMS_START + 0x26)
#define FLAG_HIDDEN_ITEM_SHENDOWN_PATH_CHILAN_BERRY          (FLAG_HIDDEN_ITEMS_START + 0x0E)
#define FLAG_HIDDEN_ITEM_SHENDOWN_PATH_TINY_MUSHROOM         (FLAG_HIDDEN_ITEMS_START + 0x0F)
#define FLAG_HIDDEN_ITEM_SHENDOWN_PATH_BIG_MUSHROOM          (FLAG_HIDDEN_ITEMS_START + 0x10)
#define FLAG_HIDDEN_ITEM_SHENDOWN_PATH_CHESTO_BERRY          (FLAG_HIDDEN_ITEMS_START + 0x11)
#define FLAG_HIDDEN_ITEM_SHENDOWN_PATH_RARE_CANDY            (FLAG_HIDDEN_ITEMS_START + 0x13)
#define FLAG_HIDDEN_ITEM_CHO_VILLAGE_FLOAT_STONE             (FLAG_HIDDEN_ITEMS_START + 0x12)
#define FLAG_HIDDEN_ITEM_CHO_VILLAGE_POKE_DOLL               (FLAG_HIDDEN_ITEMS_START + 0x14)
#define FLAG_HIDDEN_ITEM_WANGYONG_MARSH_TINY_MUSHROOM        (FLAG_HIDDEN_ITEMS_START + 0x0C)
#define FLAG_HIDDEN_ITEM_WANGYONG_MARSH_BIG_MUSHROOM         (FLAG_HIDDEN_ITEMS_START + 0x15)
#define FLAG_HIDDEN_ITEM_WANGYONG_MARSH_WACAN_BERRY          (FLAG_HIDDEN_ITEMS_START + 0x16)
#define FLAG_HIDDEN_ITEM_WANGYONG_MARSH_REPEL                (FLAG_HIDDEN_ITEMS_START + 0x17)
#define FLAG_HIDDEN_ITEM_ORACLE_HILL_OCCA_BERRY              (FLAG_HIDDEN_ITEMS_START + 0x18)
#define FLAG_HIDDEN_ITEM_ORACLE_HILL_ROSELI_BERRY            (FLAG_HIDDEN_ITEMS_START + 0x19)
#define FLAG_HIDDEN_ITEM_KIMYANG_ROAD_COLBUR_BERRY           (FLAG_HIDDEN_ITEMS_START + 0x1A)
#define FLAG_HIDDEN_ITEM_KIMYANG_ROAD_KEBIA_BERRY            (FLAG_HIDDEN_ITEMS_START + 0x1C)
#define FLAG_HIDDEN_ITEM_KIMYANG_ROAD_PERSIM_BERRY           (FLAG_HIDDEN_ITEMS_START + 0x00)
#define FLAG_HIDDEN_ITEM_KIMYANG_ROAD_POKE_BALL              (FLAG_HIDDEN_ITEMS_START + 0x1F)
#define FLAG_HIDDEN_ITEM_KIMYANG_ROAD_MUSCLE_BAND            (FLAG_HIDDEN_ITEMS_START + 0x20)
#define FLAG_HIDDEN_ITEM_ZHAOUN_PATH_CHOPLE_BERRY            (FLAG_HIDDEN_ITEMS_START + 0x21)
#define FLAG_HIDDEN_ITEM_ZHAOUN_PATH_WISE_GLASSES            (FLAG_HIDDEN_ITEMS_START + 0x22)
#define FLAG_HIDDEN_ITEM_ZHAOUN_PATH_FLUFFY_TAIL             (FLAG_HIDDEN_ITEMS_START + 0x65)
#define FLAG_HIDDEN_ITEM_ZHAOUN_PATH_ENERGY_ROOT             (FLAG_HIDDEN_ITEMS_START + 0x66)
#define FLAG_HIDDEN_ITEM_TIYU_FOREST_ENERGY_POWDER           (FLAG_HIDDEN_ITEMS_START + 0x67)
#define FLAG_HIDDEN_ITEM_TIYU_FOREST_COBA_BERRY              (FLAG_HIDDEN_ITEMS_START + 0x68)
#define FLAG_HIDDEN_ITEM_TIYU_FOREST_PAYAPA_BERRY            (FLAG_HIDDEN_ITEMS_START + 0x30)
#define FLAG_HIDDEN_ITEM_TIYU_FOREST_REPEL                   (FLAG_HIDDEN_ITEMS_START + 0x31)
#define FLAG_HIDDEN_ITEM_TIYU_FOREST_TANGA_BERRY             (FLAG_HIDDEN_ITEMS_START + 0x4C)
